...
CREATE TABLE "Trade" (
    ...
    CONSTRAINT "Trade_toUserId_fkey" FOREIGN KEY ("toUserId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "TradeItem" (
    ...
    CONSTRAINT "TradeItem_draftPickId_fkey" FOREIGN KEY ("draftPickId") REFERENCES "DraftPick" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
